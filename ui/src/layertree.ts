      ...
      children: [
        {
          ...
          url: 'https://download.swissgeol.ch/testvoxel/20231121/Voxel-Temperaturmodell-GeoMol15/tileset.json',
  ...
  children: [
    {
      ...
      children: [
        {
          type: LayerType.voxels3dtiles,
          url: 'https://download.swissgeol.ch/testvoxel/20231121/Voxel-Aaretal-Combined/tileset.json',
          voxelDataName: 'Index',
        ...
        {
          type: LayerType.voxels3dtiles,
          url: 'https://download.swissgeol.ch/testvoxel/20231121/Voxel-BIRR-Combined/tileset.json',
          voxelDataName: 'Index',
        ...
        {
          type: LayerType.voxels3dtiles,
          url: 'https://download.swissgeol.ch/testvoxel/20231121/Voxel-GENF-Combined/tileset.json',
          voxelDataName: 'Index',
        ...
        {
          type: LayerType.voxels3dtiles,
          url: 'https://download.swissgeol.ch/testvoxel/20231121/Voxel-VISP-Combined/tileset.json',
          voxelDataName: 'Index',
