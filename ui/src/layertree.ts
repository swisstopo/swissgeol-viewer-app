      ...
      children: [
        {
          ...
          url: 'https://download.swissgeol.ch/testvoxel/20231120/Voxel-Temperaturmodell-GeoMol15/tileset.json',
  ...
  children: [
    {
      ...
      children: [
        {
          type: LayerType.voxels3dtiles,
          url: 'https://download.swissgeol.ch/testvoxel/20231120/Voxel-Aaretal-Combined/tileset.json',
          voxelDataName: 'Index',
        ...
        {
          type: LayerType.voxels3dtiles,
          url: 'https://download.swissgeol.ch/testvoxel/20231120/Voxel-BIRR-Combined/tileset.json',
          voxelDataName: 'Index',
        ...
        {
          type: LayerType.voxels3dtiles,
          url: 'https://download.swissgeol.ch/testvoxel/20231120/Voxel-GENF-Combined/tileset.json',
          voxelDataName: 'Index',
        ...
        {
          type: LayerType.voxels3dtiles,
          url: 'https://download.swissgeol.ch/testvoxel/20231120/Voxel-VISP-Combined/tileset.json',
          voxelDataName: 'Index',
