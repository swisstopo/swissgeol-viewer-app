      ...
      children: [
        {
          ...
          url: 'https://download.swissgeol.ch/testvoxel/20231006/Voxel-Temperaturmodell-GeoMol15/tileset.json',
  ...
  children: [
    {
      ...
      children: [
        {
          type: LayerType.voxels3dtiles,
          url: 'https://download.swissgeol.ch/testvoxel/20231006/Voxel-Aaretal-Combined/tileset.json',
          voxelDataName: 'Index',
        ...
        {
          type: LayerType.voxels3dtiles,
          url: 'https://download.swissgeol.ch/testvoxel/20231006/Voxel-BIRR-Combined/tileset.json',
          voxelDataName: 'Index',
        ...
        {
          type: LayerType.voxels3dtiles,
          url: 'https://download.swissgeol.ch/testvoxel/20231006/Voxel-GENF-Combined/tileset.json',
          voxelDataName: 'Index',
        ...
        {
          type: LayerType.voxels3dtiles,
          url: 'https://download.swissgeol.ch/testvoxel/20230526/Voxel-GENF-Combined/tileset.json',
          voxelDataName: 'logk',
          voxelColors: logkVoxelColors,
          voxelFilter: genevaIndexVoxelFilter,
        ...
        {
          type: LayerType.voxels3dtiles,
          url: 'https://download.swissgeol.ch/testvoxel/20231006/Voxel-VISP-Combined/tileset.json',
          voxelDataName: 'Index',
