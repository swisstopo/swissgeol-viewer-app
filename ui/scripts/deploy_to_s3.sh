#!/bin/bash
# Script run automatically by the CI to deploy the UI to S3, either in the dev bucket or a review bucket.
set -e
set -x
...
# if you change something here change also in `scripts/release_ui.sh`
