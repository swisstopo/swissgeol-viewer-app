define(['exports', './Transforms-cdb50b11', './Matrix3-41c58dde', './Check-6ede7e26', './defaultValue-fe22d8c0', './Matrix2-e1298525', './AttributeCompression-f9f6c717', './ComponentDatatype-cf1fa08e', './Math-0a2ac845'], (function (exports, Transforms, Matrix3, Check, defaultValue, Matrix2, AttributeCompression, ComponentDatatype, Math$1) { 'use strict';
  ...
  var VerticalExaggeration$1 = VerticalExaggeration;
  ...
  TerrainEncoding.prototype.getExaggeratedPosition = function (
    ...
    if (hasExaggeration && this.hasGeodeticSurfaceNormals) {
      ...
      const heightDifference =
        VerticalExaggeration$1.getHeight(
          rawHeight,
          exaggeration,
          exaggerationRelativeHeight
        ) - rawHeight;
